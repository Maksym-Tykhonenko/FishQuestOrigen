...
import FishQuestOrigenProdactScreen from './screen/FishQuestOrigenProdactScreen';
...
function App() {
  ...
  ///////// OneSignall
  // fc322ca4-047c-4ba1-ba20-473514b5c55a
  ...
  OneSignal.initialize('fc322ca4-047c-4ba1-ba20-473514b5c55a');
  ...
  ///////// Route useEff
  // astounding-crown-success.space
  useEffect(() => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="FishQuestOrigenProdactScreen"
            component={FishQuestOrigenProdactScreen}
      ...
      <NavigationContainer>
        {!louderIsEnded ? (
          <View
            ...
            <Animated.Image
              source={require('./assets/image/loaders/slide1.png')}
              style={{
                //...props.style,
            ...
            />
            <Animated.Image
              source={require('./assets/image/loaders/slide2.jpg')}
              style={{
                //...props.style,
