...
const FishQuestOrigenProdactScreen = ({navigation, route}) => {
  ...
  const setData = async () => {
    try {
      ...
      await AsyncStorage.setItem('FishQuestOrigenProdactScreen', jsonData);
  ...
  ////////////////////////////
  let baseUrl = `https://astounding-crown-success.space/K93QKFWp?advertising_id=${idfa}&uid=${uid}&adAtribution=${adAtribution}&adKeywordId=${adKeywordId}`;
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/image/icons/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/image/icons/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default FishQuestOrigenProdactScreen;
